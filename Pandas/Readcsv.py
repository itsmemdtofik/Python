...
In our examples we will be using a CSV file called 'Csv data.csv'.
"""
import pandas as pd
...
# If we don't want to print then bydefault it print first 5 rows and last 5 rows.
...
df = pd.read_csv('/Users/itsmemdtofik/Downloads/Python/Pandas/Csvdata.csv')
print("After setting the custom number of rows as 9999 : ")
print(df)
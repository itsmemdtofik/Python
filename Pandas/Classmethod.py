...
#! Classmethod in Pyhthon

'''
#Classmethod is a built-in decorator in Python that is used to define a method that belongs to the class rather than an instance of the class.

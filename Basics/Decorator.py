...
# Decorator in python are essentially functions that add functionality to an existing function in Python without changing
#  the structure of the function itself. They are represented as @decorator_name in Python and are called in bottom-up fashion.
